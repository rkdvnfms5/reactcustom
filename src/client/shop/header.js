...
import { getMember, insertMember, kakaoLogin, getLoginInfo, logout, onLoading, offLoading, goLoginCheck, getViewLogList, getVisitLog, insertVisitLog } from '../../action/action';
